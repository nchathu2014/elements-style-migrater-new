...
class StyleMigrator extends Component {
  ...
  convertHTML() {
    let convertedString = replace(/pe-btn--primary/g).with("pe-btn__primary")
      ...
      .and(/pe-btn--medium/g).with("***")
      .and(/pe-btn--large/g).with("pe-btn--btn_large")
      .and(/pe-error-text/g).with("pe-input--error_message")
      .and(/check/g).with("check-lg-18")
      .and(/chevron-down/g).with("dropdown-open-18")
      .and(/chevron-up/g).with("dropdown-close-18")
      .and(/chevron-left/g).with("chevron-back-18")
      .and(/chevron-right/g).with("chevron-next-18")
      .and(/cog/g).with("settings-18")
      .and(/envelope/g).with("email-18")
      .and(/plus-circle/g).with("item-add-18")
      .and(/search/g).with("search-lg-18")
      .and(/thumb-tack/g).with("***")
      .and(/times/g).with("remove-lg-18")
      .and(/times-circle-o/g).with("item-remove-18")
      .and(/trash-o/g).with("delete-18")
      .and(/users/g).with("group-18")
      .and(/user/g).with("person-18")
      .and(/info-circle/g).with("info-fill-18")
      .and(/file-o/g).with("file-18")
      .and(/calendar/g).with("calendar-18")
      .and(/square-o/g).with("checkbox-off-18")
      .and(/check square-o/g).with("checkbox-on-18")
      .and(/ban/g).with("ban-18")
      .and(/camera/g).with("camera-18")
      .and(/clock-o/g).with("clock-18")
      .and(/exclamation-circle/g).with("warning-18")
      .and(/bell/g).with("notification-18")
      .and(/archive/g).with("archive-18")
      .and(/question-circle/g).with("help-fill-18")
      .and(/heart/g).with("favorite-on-18")
      .and(/heart-o/g).with("favorite-off-18")
      .and(/laptop/g).with("desktop-18")
      .and(/book/g).with("book-18")
      .and(/list-ul/g).with("view-list-18")
      .and(/th-large/g).with("view-tile-18")
      .and(/newspaper-o/g).with("***")
      .and(/suitcase/g).with("archive-18")
      .and(/video-camera/g).with("camera-video-18")
      .and(/picture-o/g).with("image-18")
      .and(/caret-right/g).with("pivot-close-18")
      .and(/caret-down/g).with("pivot-open-18")
      .and(/lightbulb-o/g).with("tip-18")
      .and(/shopping-cart/g).with("***")
